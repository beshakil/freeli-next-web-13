			...
			{/* File upload popup */}
				...
				<div className="backwrap">
					{props.type === 'create' ?
						<div className="createTeamModal">
							<div className="createTeamModalHead">
								...
								<h4 className="popupTitle">Create Category</h4>
							...
							<div className="createTeamModalFoot">
								{
								loader ? <button className="btnAction btn_loader" style={{ 'color': 'transparent' }}>Create Category</button>
								:
								title !== '' && title !== ' ' && title.trim() ?
								<button className="btnAction" onClick={createTeam}>Create Category</button> 
								:
										<button className="btnAction" style={{ 'opacity': '0.5' }}>Create Category</button>
								}
					...
					:
						<div className="createTeamModal">
							<div className="createTeamModalHead">
								<h4 className="popupTitle">Edit Category</h4>
								<span className="closeModal"  onClick={() => props.setCreateNewTeam(false)}></span>
